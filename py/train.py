...
parser.add_argument('--kernel', default='gaussian', type=str, help='kernel type')
parser.add_argument('--kernel_bw',default = 1. ,type= float, help='bw of the gaussian kernel')
